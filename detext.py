...
#differ the loss to balance the false positive and negative sample
...
if __name__ == "__main__":
    ...
    read_filename = "data/source/1x.sam"

    dataset_filename = "data/processed/dateset_1x.sam"
